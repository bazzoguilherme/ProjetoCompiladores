...
struct AST *create_ID(Type_Exp ast_type_exp, struct valor_lexico_t *val_lex) {
    return create_AST(ast_type_exp, val_lex, get_tipo_elemento(val_lex), NULL, NULL, NULL, NULL, NULL);
}
...
struct AST *create_FUNCAO(Type_Exp ast_type_exp, struct valor_lexico_t *val_lex, struct AST *f1) {
    return create_AST(ast_type_exp, val_lex, get_tipo_elemento(val_lex), f1, NULL, NULL, NULL, NULL);
}
